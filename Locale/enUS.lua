...
L["request_rolls_checkbox_desc"] = "Check this to requst rolls for all sessions. You can also request rolls for individual rolls by clicking the right side of each row."
L["Save Skin"] = true
