...
L["Allow RCLootCouncil to handle loot when the loot method is not master loot"] = true
L["allow_handle_loot_non_master"] = "If RCLootCouncil is enabled to handle loot and the loot method is not master loot, RCLootCouncil will add items looted by other players automatically into the session frame."
...
L["Always use master loot when entering raid instance as leader"] = true
...
L["Ask and switch to master loot when entering raid instance as leader"] = true
...
L["Item"] = true
L["Item owner on top"] = true
L["item_owner_on_top_desc"] = "If the item has an owner, always show the owner on the top of voting frame. This option normally only has effect when you are using RCLootCouncil to handle loot automatically when the loot method is not master."
...
L["never_ask_usage_desc"] = "Never ask me to start loot handling"
...
L["No longer handles looting automatically"] = true
...
L["Notes"] = true
L["Now handles looting automatically"] = true
...
L["rclootcouncil_trade_add_item_confirm"] = "RCLootCouncil detects that %s tradable items in your bag are awarded to %s in the award later list. Do you want to add the items to the trade window?"
...
L["usage_desc"] = "The following options determine whether or not RCLootCouncil starts automatically loot handling when you become the group admin(The loot master if the loot method is master, or the group leader otherwise). Regardless of your choices, you can always use '/rc startloot' to start loot handling and '/rc stoploot' to stop it."
