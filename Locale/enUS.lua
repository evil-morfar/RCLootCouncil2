...
L["rclootcouncil_trade_add_item_confirm"] = "RCLootCouncil detects that you have awarded %s items to the player you are trading with. Do you want to add the items to the trade window?"
