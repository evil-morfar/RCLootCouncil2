...
L["rclootcouncil_trade_add_item_confirm"] = "RCLootCouncil detects that %s items in your bag are awarded to %s in the award later list. Do you want to add the items to the trade window?"
