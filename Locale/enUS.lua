...
L["Allow RCLootCouncil to handle loot in personal loot"] = true
L["allow_handle_loot_in_personal"] = "If RCLootCouncil is enabled to handle loot and the loot method is personal, RCLootCouncil will add items looted by other players automatically into the session frame."
...
L["Always use master loot when entering instance as leader"] = true
...
L["Ask and switch to master loot when entering instance as leader"] = true
