...
L["Are you sure you want to reannounce all items to %s?"] = true
L["Are you sure you want to reannounce all items and request rolls from %s?"] = true
L["Armor Token"] = true
...
L["Reannounce ..."] = true
L["Reannounce and request rolls..."] = true
L["Reason"] = true
...
L["Request rolls for this session"] = true
L["request_rolls_checkbox_desc"] = "Check this to request rolls for all sessions. You can also request rolls for individual rolls by clicking the right side of each row."
L["Save Skin"] = true
