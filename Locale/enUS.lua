...
L["config"] = true
L["confirm_award_later_text"] = "Are you sure you want to award the item later? The item will be recorded in the addon's award later list and you will loot the item if the item is in a loot slot."
