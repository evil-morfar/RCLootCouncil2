...
L["Are you sure you want to give #item to #player?"] = "Are you sure you want to give %1$s to %2$s?"
L["Armor Token"] = true
...
L["Cannot give 'item' to 'player' due to Blizzard limitations. Gave it to you for distribution."] = "Cannot give %1$s to %2$s due to Blizzard limitations. Gave it to you for distribution."
...
L["chat tVersion string"] = "|cFF87CEFARCLootCouncil |cFFFFFFFFversion |cFFFFA500 %1$s - %2$s"
...
L["days, x months, y years"] = "%s, %1$d months and %2$d years"
...
L["Other piece"] = true
L["'player' can't receive 'type'"] = "%1$s can't receive %2$s - version mismatch?"
...
L["Sending 'type' to 'player'..."] = "Sending %1$s to %2$s..."
...
L["Successfully received 'type' from 'player'"] = "Successfully received %1$s from %2$s."
L["Sync"] = true
...
L["Unable to give 'item' to 'player' - (player offline, left group or instance?)"] = "Unable to give %1$s to %2$s - (player offline, left group or instance?)"
...
L["version_outdated_msg"] = "Your version %1$s is outdated. Newer version is %2$s, please update RCLootCouncil."
L["Vote"] = true
L["Voters"] = true
L["Votes"] = true
...
L["winners"] = true
L["x days"] = "%d days"
L["x out of x have voted"] = "%1$d out of %2$d have voted"
