...
L["Unable to give 'item' to 'player' - (Item has already been awarded.)"] = "Unable to give %s to %s - (Item has already been awarded.)"
L["Unable to give 'item' to 'player' - (Player offline, left group/instance or inventory full?)"] = "Unable to give %s to %s - (Player offline, left group/instance or inventory full?)"
L["Unable to give 'item' to 'player' - (Player is ineligible to receive the loot.)"] = "Unable to give %s to %s - (Player is ineligible to receive the loot.)"
