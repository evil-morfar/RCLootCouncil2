...
L["auto_repeat_desc"] = "Automatically repeat your response for any other duplicate items in the session."
L["award"] = true
...
L["Silent Auto Repeat"] = true
L["silent_auto_repeat_desc"] = "Check to hide autorepeat messages"
