...
describe("#WoWApi #Frames", function()
	describe("basic", function()
		it("can create frames", function()
			...
			local frameParent = frame1:GetParent()
			assert.equals("ScriptRegion", frameParent._type)
			local frameParentParent = frameParent:GetParent()
			assert.equals("Object", frameParentParent._type)
			assert.equals("UIParent", frame1:GetTopParent())
		end)
		...
		it("can create GameTooltips", function()
			...
			assert.are.equal("Frame", tip:GetParent()._type)
			assert.are.equal("UIParent", tip:GetTopParent())
		end)
	end)
