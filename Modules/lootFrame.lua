...
do
	local entryPrototype = {
		...
		Create = function(entry, parent)
			...
			entry.frame = CreateFrame("Frame", "DefaultRCLootFrameEntry("..LootFrame.EntryManager.numEntries..")", parent, BackdropTemplateMixin and "BackdropTemplate" or nil)
			...
			entry.noteEditbox = CreateFrame("EditBox", nil, entry.frame, "AutoCompleteEditBoxTemplate" and BackdropTemplateMixin and "BackdropTemplate" or nil)
