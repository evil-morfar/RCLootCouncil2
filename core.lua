...
function RCLootCouncil:OnInitialize()
	...
	self.nnp = false
	self.debug = false
	self.tVersion = "RC1" -- String or nil. Indicates test version, which alters stuff like version check. Is appended to 'version', i.e. "version-tVersion" (max 10 letters for stupid security)
