-- Modified to print nicely outside of game
------------------------------------------------------------------------------
-- Dump.lua
--
...
-- prefix cutoff
FORMATS["tableEntriesSkipped"] = "%s" .. DEVTOOLS_CUTOFF_COLOR .. "<skipped %s>";
-- prefix suffix
FORMATS["tableTooDeep"] = "%s" .. DEVTOOLS_CUTOFF_COLOR .. "<table (too deep)>%s";
-- prefix value suffix
...
DevTools_AddMessageHandler(print)
