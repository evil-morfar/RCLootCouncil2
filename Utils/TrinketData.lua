...
function RCLootCouncil:ExportTrinketData(nextTier, nextIsRaid, nextIndex, nextDiffID)
	...
	local TIME_FOR_EACH_INSTANCE_DIFF = 0.1
...
_G.RCTrinketCategories = {
	...
	-- The following categories does not make sense. Most likely a Blizzard error in the Encounter Journal
	-- for several old trinkets.
