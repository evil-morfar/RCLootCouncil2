...
function Compat:Run()
    for k, v in ipairs(self.list) do
        if
            v.version == "always" or
                ((v.tVersion and
                    addon:VersionCompare(addon.db.global.version, v.version, addon.db.globa.tVersion, v.tVersion)) or
                    (addon:VersionCompare(addon.db.global.version, v.version) or not addon.db.global.version)) and
                    not v.executed
         then
